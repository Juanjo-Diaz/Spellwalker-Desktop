...
public class CrearHechizoController implements Initializable {
    ...
    @FXML private TextField campoAp;
    @FXML private TextField campoMana;
    @FXML private ComboBox<String> comboTipo;
    @FXML private ComboBox<String> comboVelocidad;
    @FXML private ComboBox<String> comboEscuela;
    @FXML private CheckBox checkLegendario;
    @FXML private CheckBox checkFusion;
    ...
    public void handlerCrear(ActionEvent event) {
        try {
            ...
            if (nombre == null || nombre.isBlank() ||
                    apStr == null || manaStr == null ||
                    tipo == null || velocidad == null || escuelaNombre == null) {
            ...
            boolean creado = ConexionApi.crearHechizo(
                    nombre, ap, mana, tipo, velocidad, legendario, idEscuela, fusion
            );
